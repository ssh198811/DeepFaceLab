...
class ModelBase(object):
    def __init__(self, is_training=False,
        ...
        InfoNotifier.InfoNotifier.g_progress_info.append("当前训练的模型为: " + str(self.model_name))
        ...
        if self.model_data_path.exists():
            ...
            InfoNotifier.InfoNotifier.g_progress_info.append(f"加载模型: {self.model_name}")
        ...
        InfoNotifier.InfoNotifier.g_progress_info.append("设备选择完毕")
        QApplication.processEvents()

        InfoNotifier.InfoNotifier.g_progress_info.append("初始化网络...")
        nn.initialize(self.device_config)
        InfoNotifier.InfoNotifier.g_progress_info.append("初始化网络完毕")
        ####
        ...
        InfoNotifier.InfoNotifier.g_progress_info.append("选项设置中...")
        QApplication.processEvents()

        self.on_initialize_options()

        InfoNotifier.InfoNotifier.g_progress_info.append("选项设置中完毕")
        QApplication.processEvents()
        ...
        InfoNotifier.InfoNotifier.g_progress_info.append("模型加载中...")
        QApplication.processEvents()

        self.on_initialize()
        self.options['batch_size'] = self.batch_size

        InfoNotifier.InfoNotifier.g_progress_info.append("模型加载完毕")
        QApplication.processEvents()
    ...
    def ask_autobackup_hour(self):
        ...
        self.options['autobackup_hour'] = UIParamReflect.UIParam2Config.auto_backup
        InfoNotifier.InfoNotifier.g_progress_info.append(f"自动备份: {UIParamReflect.UIParam2Config.auto_backup}")
    ...
    def ask_write_preview_history(self):
        ...
        self.options['write_preview_history'] = UIParamReflect.UIParam2Config.write_preview_his
        ...
        self.choose_preview_history = UIParamReflect.UIParam2Config.write_preview_his
        InfoNotifier.InfoNotifier.g_progress_info.append(f"write_preview_history: {UIParamReflect.UIParam2Config.write_preview_his}")
    ...
    def ask_target_iter(self):
        ...
        self.options['target_iter'] = UIParamReflect.UIParam2Config.target_itor
        InfoNotifier.InfoNotifier.g_progress_info.append(f"target_iter: {UIParamReflect.UIParam2Config.target_itor}")
    ...
    def ask_random_flip(self):
        ...
        self.options['random_flip'] = UIParamReflect.UIParam2Config.flip_faces
        InfoNotifier.InfoNotifier.g_progress_info.append(f"random_flip: {UIParamReflect.UIParam2Config.flip_faces}")
    ...
    def ask_batch_size(self, suggest_batch_size=None):
        ...
        self.options['batch_size'] = UIParamReflect.UIParam2Config.batch_size
        InfoNotifier.InfoNotifier.g_progress_info.append(f"batch_size: {UIParamReflect.UIParam2Config.batch_size}")
