    ...
    def on_initialize(self):
        ...
        with tf.device (models_opt_device):
            ...
            if self.is_training:
                ...
                self.src_dst_opt = nn.TFRMSpropOptimizer(lr=lr, clipnorm=clipnorm, name='src_dst_opt')
                ...
                if gan_power != 0:
                    self.D_src_dst_opt = nn.TFRMSpropOptimizer(lr=lr, clipnorm=clipnorm, name='D_src_dst_opt')
